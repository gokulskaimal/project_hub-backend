...
let AdminController = class AdminController {
    constructor(_userRepo, _orgRepo, _inviteMemberUseCase, _orgManagementUseCase, _createPlanUseCase, _getPlanUseCase, _updatePlanUseCase, _deletePlanUseCase, logger) {
        ...
        this.listOrganizations = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
            ...
            const result = await this._orgRepo.findPaginated(Number(limit), Number(offset), search);
        ...
        this.updateOrganization = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
            ...
            if (updateData.status) {
                const updatedOrg = await this._orgManagementUseCase.updateOrganizationStatus(id, updateData.status);
        ...
        this.listUsers = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
            ...
            const result = await this._userRepo.findPaginated(Number(limit), Number(offset), search, filters);
            this.sendSuccess(res, result);
        });
        ...
        this.bulkInviteMembers = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
            ...
            if (!emails?.length || !orgId)
                throw new asyncHandler_1.HttpError(statusCodes_enum_1.StatusCodes.BAD_REQUEST, common_constants_1.COMMON_MESSAGES.INVALID_INPUT);
            const result = await this._inviteMemberUseCase.bulkInvite(emails, orgId, role);
        ...
        this.createPlan = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
            ...
            this.sendSuccess(res, newPlan, common_constants_1.COMMON_MESSAGES.CREATED, statusCodes_enum_1.StatusCodes.CREATED);
        });
